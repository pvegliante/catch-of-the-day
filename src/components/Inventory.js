...
class Inventory extends React.Component {
  ...
  handleChange(e, key) {
    ...
    // take a copy of that fish and update it with the new Date
    const updatedFish = {
      ...fish,
  ...
  authHandler(err, authData) {
    ...
    //quer the firebase once for the store database
    storeRef.once('value', (snapshot) => {
      const data = snapshot.val() || {};

      //clam as own if no owner already
...
Inventory.proptypes = {
  ...
  storeId: React.PropTypes.string.idRequired
}
